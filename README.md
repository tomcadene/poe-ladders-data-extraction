...
* 💾 `save_ladder_data.py`
  * The script will navigate to the specified POE leaderboard page, find, print, log and save all the ladder characters in a json file. Every X seconds the script will reload the page and repeat the process.
* 🧝 `save_new_characters.py`
  * The script will navigate to the specified POE leaderboard page, find, print, log and save all the characters and new characters of a specified account in a json file. Every X seconds the script will reload the page and repeat the process.
